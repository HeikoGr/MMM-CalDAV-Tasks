...
This devcontainer provides a MagicMirror module development environment for MMM-CalDAV-Tasks.
...
```bash
docker build -f .devcontainer/Dockerfile -t mmm-caldav-devcontainer .devcontainer
```
